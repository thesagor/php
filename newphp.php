...
class TFTestimonialCarousel_Widget_Free extends \Elementor\Widget_Base
{
    ...
    protected function render($instance = [])
    {
        ...
        ?>
        <!--<div class="tf-testimonial-carousel <?php /*echo esc_attr($settings['testimonial_style']) */ ?> <?php /*echo esc_attr($carousel_arrow); */ ?> <?php /*echo esc_attr($carousel_bullets); */ ?>"
            ...
            <div class="owl-carousel owl-theme">
                ...
                <?php foreach ($settings['carousel_list'] as $carousel): ?>
                    <div class="item">
                        <?php if ($settings['testimonial_style'] == 'style-2'): ?>
                            <div class="wrap-content">
                                ...
                                <?php if ($carousel['image_quote']['url'] != '') { ?>
                                    <div class="image-quote"><img
                                                src="<?php echo esc_url($carousel['image_quote']['url']); ?>"
                                                alt="image"></div>
                                <?php } ?>
                                ...
                                <div class="wrap-author">
                                    <?php if ($carousel['avatar']['url'] != '') { ?>
                                        <span class="avatar"><img
                                                    src="<?php echo esc_url($carousel['avatar']['url']); ?>"
                                                    alt="image"></span>
                                    <?php } ?>
                        ...
                        <?php else: ?>
                            <?php if ($carousel['image_quote']['url'] != '') { ?>
                                <div class="image-quote"><img
                                            src="<?php echo esc_url($carousel['image_quote']['url']); ?>" alt="image">
                                </div>
                            <?php } ?>
                            <div class="description"><?php echo esc_attr($carousel['description']); ?></div>
                            <div class="wrap-author">
                                <?php if ($carousel['avatar']['url'] != '') { ?>
                                    <span class="avatar"><img src="<?php echo esc_url($carousel['avatar']['url']); ?>"
                                                              alt="image"></span>
                                <?php } ?>
                                <span class="name"><?php echo esc_attr($carousel['name']); ?></span>
                                <span class="position"><?php echo esc_attr($carousel['position']); ?></span>
                ...
                <?php if ($settings['carousel_arrow'] == 'yes') { ?>
                    <div class="owl-nav-custom">
                        <div class="tf-tes-prev"><i class="<?php echo esc_attr($settings['carousel_prev_icon']) ?>"></i>
                        </div>
                        <div class="tf-tes-next"><i class="<?php echo esc_attr($settings['carousel_next_icon']) ?>"></i>
                        </div>
                    </div>
                <?php } ?>
            </div>
